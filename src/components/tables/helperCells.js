...
import ApprovedKYC from "../../containers/Page/KYC/approvedKYC";
...
import ReviewKYC from "../../containers/Page/KYC/reviewKYC";
...
const actionReviewKYC = (value, action) => {
  ReviewKYC.actionKYC(value, action);
};
const newsStatus = (
  value,
  cover_image,
      ...
      <div>
        ...
        <Tooltip title="Approved">
          <Icon
            ...
            onClick={() => actionReviewKYC(value, true)}
          />
        </Tooltip>
        <Tooltip title="Reject">
          <Icon
            ...
            onClick={() => actionReviewKYC(value, false)}
          />
        </Tooltip>
      </div>
    )}
