...
const editRole = (value, name, users, coins, announcement, staticPage, roles, countries, employee, pairs, blogs, limit_management, transaction_history, trade_history, withdraw_requests, is_active) => {
  Roles.editRole(value, name, users, coins, announcement, staticPage, roles, countries, employee, pairs, blogs, limit_management, transaction_history, trade_history, withdraw_requests, is_active);
}

const roleStatus = (value, name, users, coins, announcement, staticPage, roles, countries, employee, pairs, blogs, limit_management, transaction_history, trade_history, withdraw_requests, is_active) => {
  Roles.roleStatus(value, name, users, coins, announcement, staticPage, roles, countries, employee, pairs, blogs, limit_management, transaction_history, trade_history, withdraw_requests, is_active);
}
...
const RolesActionCell = (value, name, users, coins, announcement, staticPage, roles, countries, employee, pairs, blogs, limit_management, transaction_history, trade_history, withdraw_requests, is_active) => <div><Tooltip title="Delete"><Icon type="delete" onClick={() => deleteRole(value)} style={{ "cursor": "pointer" }} /></Tooltip><Tooltip title="Edit"><Icon type="edit" style={{ "marginLeft": "10px", "cursor": "pointer" }} onClick={() => editRole(value, name, users, coins, announcement, staticPage, roles, countries, employee, pairs, blogs, limit_management, transaction_history, trade_history, withdraw_requests, is_active)} /></Tooltip></div>;
...
const RoleSwitchCell = (value, name, users, coins, announcement, staticPage, roles, countries, employee, pairs, blogs, limit_management, transaction_history, trade_history, withdraw_requests, is_active) => <Switch checked={is_active} onChange={() => { roleStatus(value, name, users, coins, announcement, staticPage, roles, countries, employee, pairs, blogs, limit_management, transaction_history, trade_history, withdraw_requests, is_active) }} />
