...
const editRole = (value, name, users, coins, announcement, static_page, roles, countries, employee, pairs, limit_management, transaction_history, trade_history, withdraw_requests, coin_requests, inquiries, jobs, subscribe, contact_setting, kyc, is_active) => {
    Roles.editRole(value, name, users, coins, announcement, static_page, roles, countries, employee, pairs, limit_management, transaction_history, trade_history, withdraw_requests, coin_requests, inquiries, jobs, subscribe, contact_setting, kyc, is_active);
}

const roleStatus = (value, name, users, coins, announcement, static_page, roles, countries, employee, pairs, limit_management, transaction_history, trade_history, withdraw_requests, coin_requests, inquiries, jobs, subscribe, contact_setting, kyc, is_active) => {
...
const RolesActionCell = (value, name, users, coins, static_page, announcement, countries, roles, employee, pairs, limit_management, transaction_history, trade_history, withdraw_requests, coin_requests, inquiries, jobs, contact_setting, subscribe, kyc, fees, panic_button, is_active) => <div><Tooltip title="Delete"><Icon type="delete" onClick={() => deleteRole(value)} style={{ "cursor": "pointer" }} /></Tooltip><Tooltip title="Edit"><Icon type="edit" style={{ "marginLeft": "10px", "cursor": "pointer" }} onClick={() => editRole(value, name, users, coins, static_page, announcement, countries, roles, employee, pairs, limit_management, transaction_history, trade_history, withdraw_requests, coin_requests, inquiries, jobs, contact_setting, subscribe, kyc, fees, panic_button, is_active)} /></Tooltip></div>;
...
const RoleSwitchCell = (value, name, users, coins, static_page, announcement, countries, roles, employee, pairs, limit_management, transaction_history, trade_history, withdraw_requests, coin_requests, inquiries, jobs, contact_setting, subscribe, kyc, fees, panic_button, is_active) => <Switch checked={is_active} onChange={() => { roleStatus(value, name, users, coins, static_page, announcement, countries, roles, employee, pairs, limit_management, transaction_history, trade_history, withdraw_requests, coin_requests, inquiries, jobs, contact_setting, subscribe, kyc, fees, panic_button, is_active) }} />
