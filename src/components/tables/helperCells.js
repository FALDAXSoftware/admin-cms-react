...
const viewUser = (value, first_name, last_name, email, city_town, street_address, phone_number, country, dob, is_active) => {
  Users.view(value, first_name, last_name, email, city_town, street_address, phone_number, country, dob, is_active);
}
...
const userStatus = (value, first_name, last_name, email, city_town, street_address, phone_number, country, dob, is_active) => {
  Users.changeStatus(value, first_name, last_name, email, city_town, street_address, phone_number, country, dob, is_active);
}
