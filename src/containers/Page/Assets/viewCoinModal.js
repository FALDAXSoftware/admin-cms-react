  ...
  render() {
    ...
    return (
      <Modal
        ...
        footer={[<Button onClick={this._closeViewCoinModal}>OK</Button>]}
      >
        <img
          alt="asset icon"
          ...
          src={
            coinDetails.coin_icon
              ? BUCKET_URL + coinDetails.coin_icon
              : BUCKET_URL + "coin/defualt_coin.png"
          }
        />
        <br />
        <br />
        ...
        <span>
          {" "}
          <b>Minimum Trade Limit:</b>{" "}
        </span>
        <p style={{ marginBottom: "15px" }}>
          {coinDetails.orders_minimum ? coinDetails.orders_minimum : "N/A"}
        </p>
        ...
        <span>
          {" "}
          <b>Hot Receive Wallet Address:</b>{" "}
        </span>
        <p style={{ marginBottom: "15px" }}>
          {coinDetails.hot_receive_wallet_address
            ? coinDetails.hot_receive_wallet_address
            : "N/A"}
        </p>
        {/* 
