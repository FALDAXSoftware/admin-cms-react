            ...
            <div>
                <div style={{ "display": "inline-block", "width": "100%", marginLeft: '20px' }}>
                    <Link to="/dashboard/assets">
                        <i style={{ margin: '15px' }} className="fa fa-arrow-left" aria-hidden="true"></i>
                        <a onClick={() => { this.props.history.push('/dashboard/assets') }}>Back</a>
                    </Link>
                </div>
                <Tabs defaultActiveKey="1" size={'large'} >
                    <TabPane tab="Wallet" key="1"><WalletOverview asset_id={asset_id} /></TabPane>
                    <TabPane tab="History" key="2"><AssetWalletHistory asset_id={asset_id} /></TabPane>
                </Tabs>
            </div>
        );
    }
