...
class WalletDetails extends Component {
  ...
  getWalletData = async (isExportCsv = false) => {
    try {
      ...
      let res = await (
        await (isExportCsv ? ApiUtils.walletDashboard(this.props.token).getFaldaxMainWalletDetails(
          "",
          1,
          EXPORT_LIMIT_SIZE,
          "",
          ...
          2,
          ""
        ) : ApiUtils.walletDashboard(this.props.token).getFaldaxMainWalletDetails(
          coin_code,
          page,
          limit,
          sorterCol,
