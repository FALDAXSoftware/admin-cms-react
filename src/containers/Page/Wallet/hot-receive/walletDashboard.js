...
const columns=[
    ...
    },
    {
        ...
        key:1,
        width:100,
        render:data=><span>{(data["coin"]).toLowerCase()=="eth"?parseFloat(parseFloat(data["balance"]) / 1000000000000000000).toFixed(8):data["coin"].toLowerCase()!="susu"?parseFloat(parseFloat(data["balance"]) / 1000000000).toFixed(8):parseFloat(data["balance"]).toFixed(8)}</span>
    },
    {
