...
const columns=[
    ...
    },
    {
        ...
        sorter:true,
        width:75,
        render:data=><span>{data["coin"].toLowerCase()=="eth"|| data["coin"].toLowerCase()=="teth"?parseFloat(parseFloat(data["baseValue"]) / 1000000000000000000).toFixed(8):data["coin"].toLowerCase()!="susu" || data["coin"].toLowerCase()!="tsusu"?parseFloat(parseFloat(data["baseValue"]) / 100000000).toFixed(8):parseFloat(data["baseValue"]).toFixed(8)}</span>
    },
    {
