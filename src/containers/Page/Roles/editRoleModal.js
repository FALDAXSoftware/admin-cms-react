...
class EditRoleModal extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            all: this.props.fields['employee'] && this.props.fields['coins'] && this.props.fields['users'] &&
                ...
                this.props.fields['contact_setting'] &&
        ...
        if (nextProps !== this.props) {
            this.setState({
                ...
                all: nextProps.fields['coins'] && nextProps.fields['users'] && nextProps.fields['static_page'] &&
                    ...
                    nextProps.fields['contact_setting'] && nextProps.fields['subscribe'] &&
    ...
    _editRole = () => {
        ...
        const { fields, users, coins, static_page, announcement, countries,
        ...
        if (users || coins | roles || static_page || announcement || countries ||
            ...
            transaction_history || jobs || coin_requests || contact_setting ||
            contact_setting || subscribe || withdraw_requests || kyc || fees ||
            panic_button) {
    ...
    render() {
        const { loader, showEditRoleModal, fields, errMsg, errType, coins, users,
            ...
            contact_setting, coin_requests, subscribe, withdraw_requests, jobs,
