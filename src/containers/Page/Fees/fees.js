      ...
      .then(function (res) {
        if (res) {
          if (res.status == 200) {
            ...
            _this.setState({
              fields,
              prevFees: res.data.default_send_coin_fee
            });
              ...
              <TableDemoStyle className="isoLayoutContent">
                <div style={{ marginTop: "10px", marginLeft: "200px" }}>
                  ...
                  <Input
                    ...
                    onChange={this._onChangeFields.bind(
                      this,
                      "default_send_coin_fee"
                    )}
