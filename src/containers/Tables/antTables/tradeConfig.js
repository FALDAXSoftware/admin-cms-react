...
import { TextCell, DateCell, VolumeCell, ObjectCell } from '../../../components/tables/helperCells';

const renderCell = (object, type, key, pair = null, pair1 = null, reqested_email = null, emailID = null, buy = null,
    quant = null, Price = null, fillPrice = null, makerFee = null, takerFee = null, Vol = null, createdOn = null,report=null) => {
...
},
{
    ...
    width: 100,
    sorter: true,
    render: object => renderCell(object, 'ExecutionReport', 'id', 'currency', 'settle_currency',
    'reqested_user_email', 'email', 'side', 'quantity', 'price', 'fill_price', 'maker_fee', 'taker_fee'
    , 'volume', 'created_at','execution_report')
}
];
