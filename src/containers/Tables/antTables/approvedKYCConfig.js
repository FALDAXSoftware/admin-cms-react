...
import { TextCell, KYCActionCell, TierCell, DateTimeCell, KYCApprovedActionCell } from '../../../components/tables/helperCells';
...
const renderCell = (object, type, key, IDM_ID = null, fname = null, lname = null, emailId = null,
    ...
    frontDoc = null, backDoc = null, ssnNumber = null) => {
    ...
    switch (type) {
        ...
        case 'KYCApprovedActionCell':
            return KYCApprovedActionCell(value, mtid, first_name, last_name, email, direct_response,
                kycDoc_details, webhook_response, address,
                country, city, zip, dob, id_type, created_at, front_doc, back_doc, ssn);
        case 'TierCell':
