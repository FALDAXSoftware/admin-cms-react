...
import {
    TextCell, DateCell, VolumeCell, StaticImageCell, NewsDescCell, NewsSwitchCell, NewsLinkCell
...
const renderCell = (object, type, key, image = null, news_title = null, news_link = null, posted = null,
    ...
    switch (type) {
        ...
        case 'VolumeCell':
            return VolumeCell(value, cover_image, title, link, posted_at, description, is_active, owner);
        case 'NewsLinkCell':
