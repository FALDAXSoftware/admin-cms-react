...
const columns = [
    {
        title: <IntlMessages id="coinTable.title.batch" />,
        key: 'batch',
        width: 100,
        sorter: true,
        render: object => renderCell(object, 'TextCell', 'batch')
    },
    {
        title: <IntlMessages id="coinTable.title.transactions" />,
        key: 'transactions',
        width: 100,
        sorter: true,
        render: object => renderCell(object, 'TextCell', 'transactions')
    },
    {
        title: <IntlMessages id="coinTable.title.batch_date" />,
        key: 'batch_date',
        width: 200,
        sorter: true,
        render: object => renderCell(object, 'TextCell', 'batch_date')
    },
    {
