...
import { TextCell, DateTimeSecCell, VolumeOrderSell } from '../../../components/tables/helperCells';
...
const renderCell = (object, type, key, coin_pair = null, Quantity = null, price = null,
    ...
    const volume = object[Quantity] * object[fill_price];
    ...
    switch (type) {
        ...
        case 'VolumeOrderSell':
            return VolumeOrderSell(quantity, fill_price)
        default:
