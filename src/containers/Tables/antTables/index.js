...
import { tradingFeeTableInfos } from "./tradingFeeConfig";
...
export {
  ...
  pairsTableInfos,
  limitTableInfos,
  transactionTableInfos,
  tradeTableInfos,
  ownTradeTable,
  withdrawReqTableInfos,
  sellOrderTableInfos,
  buyOrderTableInfos,
  jobsTableInfos,
  jobAppTableInfos,
  ...
  newsTableInfos,
  userReferralInfos,
  userWithdrawReqTableInfos,
  ticketsTableInfos,
  accountClassTableinfos,
  templateTableinfos,
  newsSourceTableInfos,
  jobCategoryTableInfos,
  ApprovedKYCInfos,
  whitelistTableInfos,
  profileWhitelistTableInfos,
  twoFactorReqInfos,
  walletTableInfos,
  dashboardTableinfos,
  walletFeeTableinfos,
  pendingOrderTableInfos,
  cancelOrderTableInfos,
  tierTableInfos,
  tierReqTableInfos,
  tierPendingReqTableInfos,
  simplexTableInfos,
  inActiveUserinfos,
  networkFeeTableInfos,
  tradingFeeTableInfos,
  tblOffers,
};
