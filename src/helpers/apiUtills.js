...
const API_URL= "https://pre-prod-backend.faldax.com" //Pre-Production URL
...
const ApiUtils = {
    ...
    getAllTrades: function (page, limit, token, search, filterVal, startDate, endDate, sorterCol, sortOrder, trade_type) {
    ...
    getUserWallets: function (token, user_id) {
        try {
            return fetch(API_URL + "/admin/get-user-wallet-addresses?user_id=" + user_id, {
                method: 'GET',
                headers: {
                    Authorization: 'Bearer ' + token,
                    'Content-Type': 'application/json'
